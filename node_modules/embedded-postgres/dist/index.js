...
function getBestLocale() {
    ...
    try {
        const availableLocales = new Set(execSync('locale -a', { encoding: 'utf-8' })
            .split(/\r?\n/)
            .map((locale) => locale.trim())
            .filter(Boolean));
        if (availableLocales.has('en_US.UTF-8'))
            return 'en_US.UTF-8';
        if (availableLocales.has('C.UTF-8'))
            return 'C.UTF-8';
        if (availableLocales.has('en_US.utf8'))
            return 'en_US.utf8';
    }
    catch (_a) {
...
const ensureBinIsExecutable = (filePath) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield new Promise((resolve, reject) => {
                    ...
                    ], Object.assign(Object.assign({}, permissionIds), { env: Object.assign(Object.assign({}, process.env), { LC_MESSAGES: locale }) }));
                ...
                yield fs.unlink(passwordFile).catch(() => undefined);
            }
        });
    }
    /**
